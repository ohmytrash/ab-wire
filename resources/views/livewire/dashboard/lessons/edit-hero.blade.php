<div
  ...
  x-on:hero-error="onComplete"
  x-on:hero-created="onComplete"
>
  ...
  <div class="p-3">
    <div class="md:flex">
      <div id="dd" class="bg-cover bg-center md:w-80" x-bind:style="`background-image: url('{{ $lesson->hero_url['large'] }}')`">
        <img src="{{ $lesson->hero_url['large'] }}" class="invisible block w-full opacity-0" aria-hidden="true" />
      </div>
