  ...
  <div class="border-b p-3">
    ...
    <div class="flex items-center py-3">
      <input wire:model="public" id="checked-checkbox" type="checkbox"
        class="text-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600 h-4 w-4 rounded border-gray-300 bg-gray-100 shadow focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800">
      <label for="checked-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Publikasikan pelajaran</label>
    </div>
  </div>
  <div class="p-3">
