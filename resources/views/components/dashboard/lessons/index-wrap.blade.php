...
<div class="container p-3">
    <div class="mb-3 rounded border-b-4 border-primary-500 bg-white shadow">
        ...
        <div class="grid grid-cols-3 border-b p-3 md:gap-3">
            ...
            <a href="{{ route('dashboard.lessons.index', ['tab' => 'private']) }}"
            class="@if ($tab === 'private') bg-primary-600 text-white @else hover:bg-gray-100 @endif block rounded p-3 text-center text-sm font-semibold leading-none md:text-base">Pribadi</a>
        </div>
    </div>
